...
import com.yahoo.labs.samoa.learners.classifiers.rules.distributed2.AMRulesAggregatorProcessor;
import com.yahoo.labs.samoa.learners.classifiers.rules.distributed2.AMRulesStatisticsProcessor;
...
public class DistributedAMRulesRegressor2 implements RegressionLearner, Configurable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 3811388431528576022L;
